...
public class DatePickerDayGridAdapter extends RecyclerView.Adapter<DatePickerDayGridAdapter.ViewHolder> {
    ...
    @Override @NonNull
    public DatePickerDayGridAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DatePickerDayGridAdapter.ViewHolder holder, int position) {
